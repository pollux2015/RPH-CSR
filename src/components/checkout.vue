    ...
    <div class="contract">
      ...
      <div class="line-after" style="background: #fff;">
        <div class="weui-form-preview__ft">
          <a v-if="contract.tel" :href="'tel:'+contract.tel" class="weui-form-preview__btn weui-form-preview__btn_default">联系物业</a>
      ...
      <div style="margin: 20px 10px" v-if="contract.status <= 0">
        <x-button type="warn" plain @click.native="checkout">申请退房</x-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    getInfo() {
      this.$apis.checkoutInfo().then(res => {
