...
Mock.mock(aipurl_.repairList, {
  ...
  'data|1-3': [{
    ...
    'status': '已解决',
    'status_code': 1,
    'content': '家居损坏:从昨天开始我的冰箱就无法制冷',
    'images|1-3': ['http://img5.imgtn.bdimg.com/it/u=1548619045,2820406340&fm=27&gp=0.jpg', 'http://img5.imgtn.bdimg.com/it/u=3669894204,967945959&fm=27&gp=0.jpg', 'http://img2.imgtn.bdimg.com/it/u=1457831063,3293502031&fm=27&gp=0.jpg']
  }, {
    'id': '@id',
    'start_time': '@date("yyyy年MM月dd日")',
    'status': '待解决',
